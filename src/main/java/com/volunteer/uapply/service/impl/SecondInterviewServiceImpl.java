...
public class SecondInterviewServiceImpl implements SecondInterviewService {
    ...
    public UniversalResponseBody<List<SearchInterviewPojo>> listUnSecondInterviewInfo(Integer departmentId) {
        List<SearchInterviewPojo> searchInterviews = interviewMsgMapper.listSecondUnInterviewInfoByUserId(departmentId);
       ...
       /* List<ApplyPO> lists = applyMsgMapper.listApplyPOUnSecondInterview(departmentId);
        ...
        return new UniversalResponseBody<>(ResponseResultEnum.SUCCESS.getCode(), ResponseResultEnum.SUCCESS.getMsg(), searchInterviews);
    }
